...
"""
function line_search(ls::SimpleBacktracking, crit::LineSearchCriteria, ϕ, ϕ′, α=1.0, use_cache=false)
    ρ = ls.ρ          # step size decrease factor
    α_min = ls.α_min  # minimum step size
